...
class PatientControllerTest extends WebTestCase
{
    ...
    */
    ...
    public function testNewPatient(){
        ...
        $client->request('Post', '/pro/patient/new', array('username' => 'test_patient_3',
   ...
   public function testNewPatient2(){
    ...
    public function testGetInfosPatient(){
        ...
        $client = static::createClient();
        $client->request('Post', '/login_check', array('_username' => 'test_pro_1', '_password' => 'test_pro_1'));
        $client->request('Get', '/pro/patient/3', array());
        //echo $client->getResponse()->getContent();
        $this->assertTrue($client->getResponse()->getContent() == '{"id": "3", "firstName": "test_patient_2", "lastName": "test_patient_2", "userName": "test_patient_3", "phone": "0102030178", "mail": "patient2@patient.com", "city": "", "postcode": "", "address": "", "mail": "patient2@patient.com"}');
    }
    ...
    public function testListPatients(){
        ...
        //echo $client->getResponse()->getContent();
        $this->assertTrue($client->getResponse()->getContent() == '[{"id": "3","firstName": "test_patient_2", "lastName": "test_patient_2", "phone": "0102030178", "mail": "patient2@patient.com", "city": "", "postcode": "", "address": "", "mail": "patient2@patient.com"}]');
    }
}